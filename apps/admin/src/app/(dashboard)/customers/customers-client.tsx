...
export default function CustomersClient({ initialCustomers, initialTotal, stats }: CustomersClientProps) {
  ...
  }, [initialCustomers, search, brandFilter]);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-admin-card rounded-xl border border-admin-border p-4">
          ...
          <div className="text-2xl font-semibold text-admin-text mt-1">{stats.totalCustomers}</div>
        </div>
        <div className="bg-admin-card rounded-xl border border-admin-border p-4">
