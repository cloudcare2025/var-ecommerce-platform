...
export default function ProductsClient({ initialProducts, initialTotal }: ProductsClientProps) {
  ...
  }, [initialProducts, search, vendorFilter, categoryFilter, statusFilter]);
