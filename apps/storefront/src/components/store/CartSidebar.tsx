  ...
  return (
    <>
      ...
      >
          ...
          {items.length === 0 ? (
            ...
            <div className="space-y-0">
              {items.map((item) => (
                <div
                  key={item.product.id}
                  className="flex gap-4 py-4 border-b border-brand-gray-border"
                >
                  <div className="w-20 h-20 gradient-primary-soft rounded-lg flex items-center justify-center flex-shrink-0">
                    <Image
                    ...
                    <div className="flex items-center justify-between mt-2">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-7 h-7 border border-brand-gray-border rounded flex items-center justify-center hover:bg-gray-50"
                        >
        ...
        {/* Footer */}
        {items.length > 0 && (
          <div className="p-5 border-t border-brand-gray-border bg-brand-gray">
            ...
            <button className="w-full bg-foreground text-white py-3.5 rounded-lg font-bold text-[15px] hover:opacity-85 transition-opacity">
              Proceed to Checkout
            </button>
