...
import { createDhClient } from "@/lib/sync/clients/dh";
import { createIngramClient } from "@/lib/sync/clients/ingram";
import { createSynnexClient } from "@/lib/sync/clients/synnex";
import { resolveBrand } from "@/lib/sync/pipelines/brand-normalizer";
import { upsertProductWithListing } from "@/lib/sync/pipelines/cross-reference";
          ...
          const result = await upsertProductWithListing(
            {
              ...
              manufacturerId: brandResult.manufacturerId,
            },
            {
              distributor: "ingram",
