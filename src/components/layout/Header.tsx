...
const solutionGroups = [
  {
    title: "By Industry",
    items: [
      { label: "Education", href: "/solutions/industries/education", icon: GraduationCap },
      { label: "Finance", href: "/solutions/industries/finance", icon: Landmark },
      { label: "Government", href: "/solutions/industries/government", icon: Building2 },
      { label: "Healthcare", href: "/solutions/industries/healthcare", icon: Stethoscope },
      { label: "Hospitality", href: "/solutions/industries/hospitality", icon: Hotel },
      { label: "Manufacturing", href: "/solutions/industries/manufacturing", icon: Factory },
      { label: "Public Safety", href: "/solutions/industries/public-safety", icon: ShieldCheck },
      { label: "Retail", href: "/solutions/industries/retail", icon: ShoppingCart },
      { label: "Transportation", href: "/solutions/industries/transportation", icon: Truck },
    ],
  },
  {
    title: "Software & Services",
    items: [
      { label: "Knox Suite", href: "/solutions/software/knox-suite", icon: Lock },
      { label: "Samsung DeX", href: "/solutions/software/samsung-dex", icon: MonitorSmartphone },
      { label: "MagicINFO", href: "/solutions/software/magicinfo", icon: AppWindow },
      { label: "VXT", href: "/solutions/software/vxt", icon: Tv },
      { label: "Care+ for Business", href: "/solutions/software/care-plus-business", icon: Headset },
    ],
  },
];
